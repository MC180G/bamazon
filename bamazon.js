...
//Take User Quanity and multiply by Price for the Total.
  // function checkOut() {
  //     userQuanity = value;
  //     (price * userQuanity = userTotal)

      //Extra Credit: Add 5% sales tax.
  }

// console.log("It seems you would like to purchase " + userQuantity + " " + product_name + "'s at $" + price + ", which would bring your total to $" + userTotal + ". What card would you like to use?");
